    ...
    *,
    ...
    if cand_n > 1:
        ...
        for i in range(cand_n):
            ...
            res = generate_wav(
                ...
                layered_transient_gain_db=layered_transient_gain_db,
                layered_body_hp_hz=layered_body_hp_hz,
                layered_body_lp_hz=layered_body_lp_hz,
                layered_body_drive=layered_body_drive,
                layered_body_gain_db=layered_body_gain_db,
                layered_tail_hp_hz=layered_tail_hp_hz,
                layered_tail_lp_hz=layered_tail_lp_hz,
                layered_tail_drive=layered_tail_drive,
                layered_tail_gain_db=layered_tail_gain_db,
    ...
    if engine == "layered":
        ...
        lp = LayeredParams(
            ...
            transient_gain_db=float(layered_transient_gain_db),
            body_hp_hz=float(layered_body_hp_hz),
            body_lp_hz=float(layered_body_lp_hz),
            body_drive=float(layered_body_drive),
            body_gain_db=float(layered_body_gain_db),
            tail_hp_hz=float(layered_tail_hp_hz),
            tail_lp_hz=float(layered_tail_lp_hz),
            tail_drive=float(layered_tail_drive),
            tail_gain_db=float(layered_tail_gain_db),
