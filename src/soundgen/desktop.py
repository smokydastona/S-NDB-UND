...
def run_desktop(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Run the Sound Generator UI in a native desktop window (embedded webview).")
    ...
    webview.create_window("Sound Generator", local_url, width=1200, height=800)
    webview.start()
    return 0
